...
# ═══════════════════════════════════════════════════════════
# ═══════════════════════════════════════════════════════════
# ☁️ 2. auth.html - واجهة تسجيل دخول فاخرة مع Google وFacebook
# ═══════════════════════════════════════════════════════════
...
<head>
    ...
    <style>
        ...
        * {{
        ...
        .bg-orb:nth-child(1) {{ width: 400px; height: 400px; background: #ec4899; top: -100px; right: -100px; }}
        .bg-orb:nth-child(2) {{ width: 350px; height: 350px; background: #f472b6; bottom: -100px; left: -100px; animation-delay: 5s; }}
        .bg-orb:nth-child(3) {{ width: 300px; height: 300px; background: #a855f7; top: 50%; left: 50%; animation-delay: 10s; }}
        ...
        .auth-card {{
            ...
            box-shadow: 0 30px 70px rgba(236, 72, 153, 0.15), 0 0 50px rgba(236, 72, 153, 0.05);
        ...
        .toast-msg {{
            ...
            pointer-events: none;
            transition: all 0.4s;
            box-shadow: 0 10px 30px rgba(0, 0, 0, 0.5), 0 0 20px rgba(236, 72, 153, 0.2);
        }}
        .toast-msg.show {{
            opacity: 1;
...
<div class="auth-card">
    ...
    <div class="logo-section">
        ...
        <div class="logo-title">لحظة</div>
        <div class="logo-subtitle">Lahza ✨</div>
    </div>
    
    <!-- رسالة ترحيب -->
    <div class="welcome-msg">
        💗 شارك لحظاتك الجميلة مع العالم
    </div>
    
    <!-- أزرار التواصل الاجتماعي -->
    <div class="social-section">
        <div class="social-label">المتابعة السريعة</div>
    ...
    <div id="formLogin" class="form active">
        ...
        <div class="input-group">
            ...
            <button class="toggle-password" onclick="togglePasswordVisibility('loginPass', this)" type="button">
        ...
        <div class="forgot-link">
            <a href="#" onclick="event.preventDefault(); showToast('🔜 سيتم إضافة هذه الميزة قريباً')">
                نسيت كلمة المرور؟
            </a>
        </div>
    </div>
    ...
    <div id="formRegister" class="form">
        ...
        <div class="input-group">
            ...
            <i class="fas fa-lock input-icon"></i>
            <button class="toggle-password" onclick="togglePasswordVisibility('regPass', this)" type="button">
                <i class="fas fa-eye"></i>
            </button>
        </div>
...
<script>
    ...
    async function signInWithGoogle() {{
        ...
        try {{
            ...
            if(error.code === 'auth/popup-closed-by-user') {{
                ...
                showToast('❌ الرجاء السماح بالنوافذ المنبثقة');
            }} else {{
    ...
    console.log('💗 لحظة | Auth Ready with Google & Facebook ✨');
</script>
</body>
</html>"""
# ═══════════════════════════════════════════════════════════
# ☁️ 3. index.html - لحظة | Lahza - الرئيسية المطورة
# ═══════════════════════════════════════════════════════════
...
<head>
    ...
    <style>
        {COMMON_CSS}
        body{{height:100vh;overflow:hidden;background:radial-gradient(ellipse at top, #1a0a14, #0d060c, #020617);}}
        ...
        .loader-logo{{
            ...
            font-size:36px;animation:pulse 1.5s ease-in-out infinite;
            box-shadow:0 0 40px rgba(236,72,153,0.6),0 0 80px rgba(236,72,153,0.2);
        }}
        @keyframes pulse{{
            0%,100%{{transform:scale(1);box-shadow:0 0 40px rgba(236,72,153,0.6)}}
            50%{{transform:scale(1.1);box-shadow:0 0 60px rgba(236,72,153,0.9)}}
        }}
        .loader-title{{
        ...
        .logo-icon{{
            ...
            font-size:18px;box-shadow:0 4px 15px rgba(236,72,153,0.4);
        ...
        .tab.active{{
            background:linear-gradient(135deg,rgba(236,72,153,0.3),rgba(244,114,182,0.2));
            color:#fff;box-shadow:0 4px 15px rgba(236,72,153,0.2);
        }}
        ...
        .tab-badge.show{{display:block;animation:blink 1s infinite}}
        ...
        .top-icon:hover{{
            color:var(--accent2);background:rgba(236,72,153,0.1);
            transform:scale(1.1);
        }}
        .notif-badge{{
        ...
        .author-avatar{{
            ...
            background:linear-gradient(135deg,#ec4899,#f472b6,#fbcfe8);
            padding:3px;animation:pinkStoryRing 3s ease-in-out infinite;
            flex-shrink:0;
        }}
        @keyframes pinkStoryRing{{
            0%,100%{{box-shadow:0 0 15px rgba(236,72,153,0.4)}}
            50%{{box-shadow:0 0 30px rgba(244,114,182,0.8)}}
        }}
        ...
        .verified-badge-main{{
            ...
            animation:verifyGlow 2s infinite;
        }}
        @keyframes verifyGlow{{
            0%,100%{{box-shadow:0 0 12px rgba(244,114,182,0.6)}}
            50%{{box-shadow:0 0 25px rgba(244,114,182,1)}}
        }}
        .btn-follow{{
            background:linear-gradient(135deg,#ec4899,#f472b6);
        ...
        .caption{{
            font-size:14px;margin-bottom:6px;line-height:1.5;
            max-height:60px;overflow:hidden;position:relative;
        }}
        .caption.expanded{{max-height:none}}
        .tag{{color:var(--accent2);cursor:pointer;font-weight:600}}
        .tag:hover{{text-decoration:underline}}
        
        .music-row{{
            font-size:12px;opacity:0.8;display:flex;align-items:center;
            gap:8px;cursor:pointer;margin-top:4px;
        }}
        .music-wave{{display:flex;gap:2px;align-items:flex-end;height:16px}}
        .music-wave span{{
            width:2px;background:var(--accent2);border-radius:1px;
        ...
        .watermark-overlay:hover{{opacity:0.8}}
        .watermark-overlay .wm-text{{
            font-weight:800;font-size:13px;
            text-shadow:0 2px 8px rgba(0,0,0,0.6);
            color:#fff;letter-spacing:1px;
        }}
        .watermark-overlay .wm-icon{{
        ...
        .sbtn i{{
            font-size:28px;filter:drop-shadow(0 3px 8px rgba(0,0,0,0.5));
            transition:all 0.3s;
        }}
        .sbtn:hover i{{filter:drop-shadow(0 3px 12px rgba(236,72,153,0.8))}}
        .sbtn.liked i{{
            color:var(--accent);
        ...
        .sbtn .cnt{{font-weight:700;font-size:11px;color:rgba(255,255,255,0.9)}}
        ...
        .views-display i{{color:var(--accent2);animation:eyePulse 2s infinite}}
        @keyframes eyePulse{{
            0%,100%{{opacity:1}}
            50%{{opacity:0.5}}
        }}
        ...
        .share-item:hover{{transform:translateY(-5px) scale(1.05)}}
        ...
        .share-item span{{font-size:11px;opacity:0.7;font-weight:600}}
        .share-copy-row{{
        ...
        .comments-panel{{
            ...
            border-top:2px solid var(--accent);
            border-radius:24px 24px 0 0;
            padding:0;z-index:500;max-height:70vh;
        ...
        .comment-actions{{
            display:flex;gap:16px;margin-top:6px;font-size:11px;
        }}
        .comment-actions span{{
            cursor:pointer;opacity:0.6;display:flex;
            align-items:center;gap:4px;transition:all 0.2s;
        }}
        .comment-actions span:hover{{opacity:1;color:var(--accent2)}}
        ...
        .comment-input-row{{
            ...
            background:rgba(2,6,23,0.95);flex-shrink:0;
        }}
        ...
        .comment-input-row button{{
            ...
            white-space:nowrap;font-size:13px;transition:all 0.3s;
        }}
        ...
        .player-controls{{
            ...
            border:1px solid rgba(236,72,153,0.3);
            z-index:10000;color:#fff;gap:12px;flex-wrap:wrap;
        }}
        .player-controls button{{
            background:none;border:none;color:#fff;
            font-size:20px;cursor:pointer;
            transition:all 0.2s;padding:5px;
        }}
        .player-controls button:hover{{
            color:#f472b6;transform:scale(1.1);
        }}
        .progress-wrap{{
        ...
        .btn-add{{
            ...
            justify-content:center;margin-top:-30px;cursor:pointer;
        ...
        .btn-add:hover{{
            ...
            box-shadow:0 15px 40px rgba(236,72,153,0.8);
        }}
    </style>
</head>
<body>
...
<div id="loaderScreen">
    ...
    <div class="loader-title">لحظة</div>
    <div class="loader-subtitle">Lahza - شارك لحظاتك</div>
...
<div id="mainApp">
    ...
    <div class="topbar">
        <div class="logo-container">
            <div class="logo-icon">💗</div>
            <div>
                <div class="logo-text-ar">لحظة</div>
                <div class="logo-text-en">Lahza</div>
            </div>
        </div>
        <div class="tabs">
            <button class="tab" onclick="switchFeed('following')">متابَعين</button>
            <button class="tab active" onclick="switchFeed('forYou')">لك <span class="tab-badge" id="foryouBadge"></span></button>
        </div>
        <div class="top-icons">
            <button class="top-icon" onclick="openNotifs()">
    ...
    <div class="videos-wrap" id="videosWrap">
        <div style="display:flex;align-items:center;justify-content:center;height:100vh;color:rgba(255,255,255,0.5);flex-direction:column;gap:16px">
            <i class="fas fa-heart" style="font-size:56px;opacity:0.3;color:#ec4899;animation:float 2s infinite"></i>
            <p style="font-size:16px;font-weight:600">لا توجد فيديوهات بعد</p>
            <p style="font-size:12px;opacity:0.5">كن أول من يشارك لحظته! 💗</p>
        </div>
    </div>
    ...
    <div class="fullscreen-player" id="fullscreenPlayer" onclick="if(event.target===this)closePlayer()">
        ...
        <div class="player-controls">
            ...
            <div class="progress-wrap">
                ...
                <span id="duration" style="font-size:12px">0:00</span>
            </div>
            <button onclick="toggleMutePlayer()"><i class="fas fa-volume-up" id="muteIcon"></i></button>
            <a id="downloadLink" href="#" download style="color:#f472b6;text-decoration:none;margin-left:10px;font-size:20px"><i class="fas fa-download"></i></a>
        </div>
    </div>

    <!-- ═══ لوحة المشاركة ═══ -->
    <div class="share-panel" id="sharePanel">
        <h3><i class="fas fa-share-alt"></i> مشاركة اللحظة</h3>
...
<script>
    ...
    function shareTo(platform) {{
        ...
        const text = encodeURIComponent('شاهد هذه اللحظة على لحظة 💗');
        let shareUrl = '';
        switch(platform) {{
    ...
    async function loadComments() {{
        ...
        if(!commentsArr.length) {{
            list.innerHTML = '<div style="text-align:center;opacity:0.5;padding:30px"><i class="fas fa-comment-slash" style="font-size:32px;color:var(--accent);margin-bottom:8px;display:block"></i>لا توجد تعليقات - كن أول من يعلق!</div>';
            return;
        }}
    ...
    async function addComment() {{
        ...
        if(replyingTo) {{
            ...
            if(video && video.sender !== currentUser.uid) {{
                sendNotification(video.sender, currentUserData?.username, 'علق على لحظتك 💬');
            }}
        }}
        input.value = '';
        await loadComments();
    ...
    function renderVideos() {{
        ...
        if(!filtered.length) {{
            container.innerHTML = `<div style="display:flex;align-items:center;justify-content:center;height:100vh;color:rgba(255,255,255,0.5);flex-direction:column;gap:16px">
                <i class="fas fa-heart" style="font-size:56px;opacity:0.3;color:#ec4899;animation:float 2s infinite"></i>
                <p style="font-size:16px;font-weight:600">${{currentFeed === 'forYou' ? 'لا توجد لحظات بعد' : 'تابع مستخدمين لرؤية لحظاتهم'}}</p>
            </div>`;
            return;
        }}
        container.innerHTML = '';
                ...
                <div class="vid-info">
                    <div class="author-row">
                        ...
                        <div class="author-name">
                            ...
                            ${{verifiedBadgeHtml}}
                            ${{currentUser?.uid !== video.sender ? `<button class="btn-follow ${{isFollowing ? 'following' : ''}}" onclick="event.stopPropagation();toggleFollow('${{video.sender}}', this)">${{isFollowing ? '<i class="fas fa-user-check"></i> متابع' : '<i class="fas fa-user-plus"></i> متابعة'}}</button>` : ''}}
                        </div>
                    </div>
                    <div class="caption">${{caption}}</div>
                    <div class="music-row">${{musicHtml}}</div>
    ...
    async function toggleLike(videoId, btn) {{
        ...
        if(likedBy[currentUser.uid]) {{
            ...
            if(video.sender && video.sender !== currentUser.uid) {{
                sendNotification(video.sender, currentUserData?.username, 'أعجب بلحظتك ❤️');
            }}
        }}
...
# ═══════════════════════════════════════════════════════════
# ☁️ 5. profile.html - ملف شخصي محترف مطور (مع نافذة متابعين + مشغل داخلي + مشاركات)
# ═══════════════════════════════════════════════════════════════════════════════════
...
<head>
    ...
    <style>
        ...
        .followers-modal.show{{display:flex;animation:fadeIn 0.3s ease}}
        .followers-modal-content{{
            position:relative;max-width:400px;width:90%;max-height:80vh;
            background:rgba(2,6,23,0.98);border-radius:24px;overflow:hidden;
            border:1px solid rgba(236,72,153,0.4);
            box-shadow:0 0 60px rgba(236,72,153,0.3);
            animation:slideUp 0.3s ease;
        ...
        .followers-modal-close:hover{{background:var(--accent);transform:rotate(90deg)}}
        .followers-list{{
        ...
        .follower-avatar{{
            ...
            border:2px solid rgba(236,72,153,0.4);flex-shrink:0;
        }}
        ...
        .follower-action-btn{{
            background:rgba(236,72,153,0.1);border:1px solid var(--border);
            padding:8px 16px;border-radius:20px;color:var(--accent2);
...
<div id="content" style="display:none">
    ...
    <div class="stats-row">
        <div class="stat-item" onclick="showFollowersList('following')"><div class="stat-val" id="statFollowing">0</div><div class="stat-lbl">يتابع</div></div>
        <div class="stat-item" onclick="showFollowersList('followers')"><div class="stat-val" id="statFollowers">0</div><div class="stat-lbl">متابع</div></div>
    ...
    <div class="video-modal-content">
        ...
        <div class="video-modal-info">
            ...
            <div class="video-modal-actions">
                ...
                <button class="video-action-btn" onclick="shareCurrentVideo('whatsapp')">
                    <i class="fab fa-whatsapp" style="color:#25D366"></i> واتساب
                </button>
                <button class="video-action-btn" onclick="shareCurrentVideo('telegram')">
                    <i class="fab fa-telegram" style="color:#0088cc"></i> تيليجرام
                </button>
...
<div class="followers-modal" id="followersModal">
    <div class="followers-modal-content">
        <div class="followers-modal-header">
            <h3 id="followersModalTitle"><i class="fas fa-users"></i> المتابِعون</h3>
            <div class="followers-modal-close" onclick="closeFollowersModal()"><i class="fas fa-times"></i></div>
        </div>
...
<script>
    ...
    let currentFollowersType = 'followers';
    ...
    function showFollowersList(type) {{
        ...
        title.innerHTML = type === 'followers' 
            ? '<i class="fas fa-users"></i> المتابِعون'
            : '<i class="fas fa-user-friends"></i> يتابع';
        
        if(!ids.length) {{
            listContainer.innerHTML = '<div class="empty-state"><i class="fas fa-user-slash"></i><p>لا يوجد مستخدمون</p></div>';
        }} else {{
            listContainer.innerHTML = ids.map(id => {{
                const user = allUsers[id];
                if(!user) return '';
                const avatar = user.avatarUrl || (DICEBEAR_URL + '?seed=' + id);
                const isFollowing = currentUserData?.following?.[id];
                const isSelf = id === currentUser?.uid;
                const verifiedBadge = user.isVerified ? '<span class="badge-verified" style="width:16px;height:16px;font-size:9px"><i class="fas fa-check"></i></span>' : '';
                
                let actionBtn = '';
                if(isSelf) {{
                    actionBtn = '<span style="font-size:11px;color:var(--text-muted)">أنت</span>';
                }} else {{
                    actionBtn = `<button class="follower-action-btn ${{isFollowing ? 'following' : ''}}" onclick="toggleFollowFromList('${{id}}', this)">
                        ${{isFollowing ? 'متابع ✓' : 'متابعة'}}
                    </button>`;
                }}
                
                return `<div class="follower-item">
                    <div class="follower-info" onclick="openUserProfile('${{id}}')">
                        <div class="follower-avatar"><img src="${{avatar}}" alt="${{user.username}}"></div>
                        <div class="follower-details">
                            <h4>@${{user.username || 'مستخدم'}} ${{verifiedBadge}}</h4>
                            <p>${{user.bio || 'لا توجد سيرة ذاتية'}}</p>
                        </div>
                    </div>
                    ${{actionBtn}}
                </div>`;
    ...
    async function toggleFollowFromList(userId, btn) {{
        ...
        await loadProfile();
        // تحديث القائمة
        showFollowersList(currentFollowersType);
    }}
    ...
    function shareCurrentVideo(platform) {{
        if(!currentVideoData) return;
        const url = currentVideoData.url;
        const text = `شاهد هذا الفيديو الرائع 💗 ${{currentVideoData.description || ''}}`;
        ...
        if(platform === 'whatsapp') {{
            ...
            if(navigator.share) {{
                navigator.share({{title: 'MNAENCA', text: text, url: url}});
            }} else {{
                copyVideoLink();
            }}
        }}
